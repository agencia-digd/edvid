...
Editor de vídeo por conversa. Você joga o material bruto numa pasta, abre o
Claude Code ali e diz *"edita isso num Reels"*. Ele transcreve, escolhe as
melhores tomadas, corta os silêncios, corrige a cor e te mostra o resultado para
aprovação — depois entram legendas, gráficos e trilha.
...
Skill de agente. App desktop (separado):
